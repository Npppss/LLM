...
# installed.
TCL_PREFIX='D:/LLM/Langchain/LLM/LCEL/LCEL\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/LLM/Langchain/LLM/LCEL/LCEL\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/LLM/Langchain/LLM/LCEL/LCEL\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/LLM/Langchain/LLM/LCEL/LCEL\Library\include'
...
TCL_PACKAGE_PATH='D:/LLM/Langchain/LLM/LCEL/LCEL\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/LLM/Langchain/LLM/LCEL/LCEL\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/LLM/Langchain/LLM/LCEL/LCEL\Library\lib\tclstub86.lib'
