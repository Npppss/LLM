...
# installed.
TCL_PREFIX='D:/LLM/ANN-RNN/ANN-RNN\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/LLM/ANN-RNN/ANN-RNN\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/LLM/ANN-RNN/ANN-RNN\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/LLM/ANN-RNN/ANN-RNN\Library\include'
...
TCL_PACKAGE_PATH='D:/LLM/ANN-RNN/ANN-RNN\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/LLM/ANN-RNN/ANN-RNN\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/LLM/ANN-RNN/ANN-RNN\Library\lib\tclstub86.lib'
